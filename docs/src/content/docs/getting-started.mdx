...
If you've found anything wrong or unexpected, please [open an issue on GitHub](https://github.com/lunariajs/lunaria/issues/new).
:::
...
Visit the [Configuration Reference guide](/reference/configuration) to set them up and then follow the instructions below.
